        ...
        <div className='container'>
            ...
            <div className='chipArea'>
                <div className='firstLine'>
                    ...
                    <Chip textContent='Sustentabilidade' backgroundColor='#17B270' background='#17B270' width='315px' imgSize='38px' />
                    <Chip textContent='Segurança' backgroundColor='#EB3D38' background='#EB3D38'  imgSize='42px' />
                    <Chip textContent='Tempo' backgroundColor='#2B388A' background='#2B388A' color="#FEFEFE"  imgSize='45px' />
                ...
                <div className='secondLine'>
                    ...
                    <Chip textContent='Centralização' backgroundColor='#EB72AC' background='#EB72AC'  imgSize='42px' />
                    <Chip textContent='Integração' backgroundColor='#ED8024' background='#ED8024'  imgSize='42px' />
