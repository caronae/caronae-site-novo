        ...
        <div className='container'>
            ...
            <div className='chipArea'>
                <div className='firstLine'>
                    ...
                    <Chip textContent='Sustentabilidade' backgroundColor='#17B270' background='#17B270' width='315px' imgSrc={sustentabilidade} imgSize='25px' />
                    <Chip textContent='Segurança' backgroundColor='#EB3D38' background='#EB3D38' imgSrc={seguranca} imgSize='30px' />
                    <Chip textContent='Tempo' backgroundColor='#2B388A' background='#2B388A' color="#FEFEFE" imgSrc={tempo} imgSize='35px' />
                ...
                <div className='secondLine'>
                    ...
                    <Chip textContent='Centralização' backgroundColor='#EB72AC' background='#EB72AC' imgSrc={centralizacao} imgSize='25px' />
                    <Chip textContent='Integração' backgroundColor='#ED8024' background='#ED8024' imgSrc={integracao} imgSize='25px' />
