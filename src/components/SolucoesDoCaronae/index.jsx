...
const Titulo = () => {
  return (
    <div className="titulo">
      <h1>
        Nós desenvolvemos uma solução para tornar a mobilidade
        sustentável
      </h1>
    </div>
  );
...
const PontosDeCarona = () => {
  return (
    <div className="pontos-de-carona">
      ...
      <p>
        São placas localizadas dentro do ambiente universitário onde
        os motoristas podem oferecer uma carona e os passageiros
        podem aguardar ela.
      </p>
    </div>
  );
...
const InfoApp = () => {
  return (
    <div className="info-app">
      <h2>Aplicativo</h2>
      <p>
        Conecta pessoas que desejam pegar uma carona e motoristas. O
        Caronaê tem como objetivo reduzir o impacto ambiental causado
        pelos transportes.
      </p>
      <Link className="botao-app" style={{ textDecoration: 'none' }}>
        Conheça o app do Caronaê
      </Link>
    </div>
  );
};
